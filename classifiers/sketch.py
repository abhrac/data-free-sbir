...
def main():
    ...
    data_train = datasets.ImageFolder(root=os.path.join(args.data, 'train', 'sketch'), transform=transforms)
    data_test = datasets.ImageFolder(root=os.path.join(args.data, 'test', 'sketch'), transform=transforms)
    ...
    for e in range(args.num_epochs):
        ...
        torch.save(classifier.state_dict(), args.output_dir + 'sketch_classifier.pth')
